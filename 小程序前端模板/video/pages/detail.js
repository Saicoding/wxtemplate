...
Page({
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      path: '/page/headlines/video/index?id=' + wxb.that.data.id,
  ...
  comment: function (e) {
    ...
    if (!content) {
      ...
      wxb.Post("/api/video.index/comment", {
        id: wxb.that.data.id,
        openid: wxb.getOpenId(),
        content: content,
      }, function (data2) {
  ...
  onLoad: function (options) {
    ...
    wxb.Post("/api/video.index/detail", {
      openid: wxb.getOpenId(),
      id: id,
    }, function (data) {
      wx.hideLoading();
    ...
    wxb.Post("/api/video.index/getCommentList", {
      id: id,
      page: 1,
      openid: wxb.getOpenId()
    }, function (data2) {
